...
//            }
    ...
    override func viewDidLoad() {
        ...
        button.leftAnchor.constraint(equalTo: self.ShoeInfo.leftAnchor).isActive = true
        button.centerYAnchor.constraint(equalTo: self.ShoePrice.centerYAnchor).isActive = true
